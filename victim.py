...
# Define the address and port, the address 0.0.0.0 refers to the fact that we accept connections from any interface
server_address = ('0.0.0.0', 5000)

# Create the socket (the connection)
server_socket = socket()

# Pass the tuple where we specify where to listen
...
while state:
    ...
    if command == 'exit':
        ...
        # Execute the command and obtain its output
